        ...
        <div className="w-full flex flex-col items-center justify-center my-0.5">
          ...
          >
            <div className="flex items-center justify-center gap-2 sm:gap-2.5 flex-nowrap">
              ...
              >
                <Eye className="w-3 h-3 xs:w-3.5 xs:h-3.5 sm:w-4 sm:h-4 text-[#A47E43] group-hover:scale-110 transition-transform" />
                <span>PREVIEW</span>
              </button>
              ...
              >
                <Upload className="w-3 h-3 xs:w-3.5 xs:h-3.5 sm:w-4 sm:h-4 text-[#A47E43] group-hover:text-[#8D652B] transition-colors" />
                <span className="text-[8.5px] xs:text-[9.5px] sm:text-[11px] font-bold tracking-[0.14em] uppercase font-sans">
                  PRINT YOUR ALBUMS
                </span>
              </button>
              ...
              <a
                ...
                className="group inline-flex items-center gap-1.5 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white text-[9px] xs:text-[10px] sm:text-xs font-bold tracking-wider uppercase shadow-[0_4px_14px_rgba(37,211,102,0.38)] hover:shadow-[0_6px_20px_rgba(37,211,102,0.55)] hover:scale-105 active:scale-95 transition-all duration-300 cursor-pointer backdrop-blur-sm whitespace-nowrap"
                title="Chat with KPR Colour Lab on WhatsApp (+91 98493 90876)"
                aria-label="Chat with KPR Colour Lab on WhatsApp"
              >
                <svg className="w-3 h-3 xs:w-3.5 xs:h-3.5 sm:w-4 sm:h-4 fill-current" viewBox="0 0 24 24">
