...
export default function Hero({ onOpenPage }) {
  ...
  return (
    <section
      id="hero"
      className="relative w-full min-h-[100svh] md:h-[100svh] md:max-h-[100svh] overflow-y-auto md:overflow-hidden flex flex-col justify-between bg-[#07090D] text-white pt-16 sm:pt-18 md:pt-20 pb-2 sm:pb-3 md:pb-4 px-2 sm:px-6 lg:px-8 select-none"
    ...
    >
      ...
      <div className="w-full flex-1 flex flex-col items-center justify-center z-20 py-1 sm:py-2 pointer-events-auto max-w-4xl mx-auto">
        {/* Eyebrow Pill Badge */}
        <motion.div
          initial={{ opacity: 0, y: -8 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.35 }}
          className="inline-flex items-center gap-1.5 px-3 py-0.5 sm:py-1 rounded-full bg-[#FAF7F2]/90 border border-[#D8CFC4] text-[#8C6D3F] text-[9px] sm:text-[10px] font-bold tracking-widest uppercase shadow-xs mb-1 sm:mb-1.5"
        >
        ...
        <motion.h2
          ...
          className="font-serif text-base sm:text-xl md:text-2xl lg:text-[26px] font-normal text-[#1A1A1A] tracking-tight text-center leading-tight max-w-3xl px-2 mb-0.5 whitespace-normal md:whitespace-nowrap"
        >
        ...
        <motion.p
          ...
          className="text-[9.5px] sm:text-[11px] md:text-xs text-[#555555] font-light text-center tracking-normal px-4 mb-1 sm:mb-1.5"
        >
        ...
        >
          ...
          <div className="absolute left-0 sm:left-2 md:left-6 lg:left-10 top-1/2 -translate-y-1/2 pointer-events-none select-none z-20">
            <img
              src="/images/swipe_to_explore.png"
              alt="Swipe to explore"
              className="w-12 sm:w-16 md:w-20 h-auto object-contain drop-shadow-xs -rotate-2"
              draggable="false"
            />
          </div>
          ...
          >
            <img
              ...
              className="w-[220px] sm:w-[260px] md:w-[310px] lg:w-[340px] max-h-[160px] sm:max-h-[185px] md:max-h-[200px] max-w-[85vw] h-auto object-contain select-none drop-shadow-[0_15px_30px_rgba(0,0,0,0.22)] group-hover:drop-shadow-[0_22px_38px_rgba(0,0,0,0.3)] transition-all duration-300"
              draggable="false"
            />
          </div>
        </motion.div>
        ...
        >
          <button
            type="button"
            onClick={() => setUploadModalOpen(true)}
            className="group inline-flex items-center gap-2 sm:gap-2.5 px-4 sm:px-6 py-1.5 sm:py-2 rounded-full bg-[#141414] hover:bg-[#000000] text-white border border-white/20 hover:border-[#C5A880] shadow-[0_6px_16px_rgba(0,0,0,0.3)] hover:shadow-[0_10px_24px_rgba(197,168,128,0.3)] hover:scale-105 active:scale-95 transition-all duration-300 cursor-pointer"
          >
            <BookOpen className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-white group-hover:text-[#C5A880] transition-colors" />
            <span className="text-[9.5px] sm:text-[11px] font-bold tracking-[0.16em] uppercase font-sans">
              EXPLORE YOUR ALBUM
            </span>
      ...
      {/* ── 3. Unified 3-Column Services Showcase Cards (100% Fully Visible inside viewport) ── */}
      <div className="w-full max-w-4xl lg:max-w-5xl mx-auto grid grid-cols-3 gap-1.5 sm:gap-3 md:gap-4 z-10 mb-1 sm:mb-2 py-0 px-0.5 sm:px-1">
        {SERVICES.map((service, index) => {
          return (
            <motion.div
              ...
              className="group relative bg-[#FAF7F2]/95 hover:bg-[#FFFFFF] backdrop-blur-xl border border-[#D8CFC4]/90 hover:border-[#1A1A1A]/60 rounded-xl sm:rounded-2xl p-1.5 sm:p-2.5 md:p-3 flex flex-col items-center text-center justify-between transition-all duration-300 cursor-pointer hover:scale-[1.02] shadow-[0_6px_20px_rgba(0,0,0,0.08)] hover:shadow-[0_12px_30px_rgba(0,0,0,0.18)]"
            >
              ...
              <div className="h-7 sm:h-9 md:h-11 w-full flex items-center justify-center mb-0.5">
                <img
                  src={service.logoSrc}
                  alt={service.title}
                  className="max-h-7 sm:max-h-9 md:max-h-11 w-auto max-w-[90%] sm:max-w-[85%] object-contain drop-shadow-xs group-hover:scale-105 transition-transform duration-300 select-none"
                  loading="eager"
                />
              </div>
              ...
              {service.showTitleText ? (
                <h3 className="text-[8.5px] sm:text-xs md:text-sm lg:text-base font-black tracking-wide text-[#1A1A1A] uppercase font-sans mt-0.5 truncate max-w-full">
                  {service.title}
                </h3>
              ) : (
              ...
              {/* 4. Supporting Visual Asset (Compact Sleek Horizontal Banner) */}
              <div className="w-full h-8 sm:h-11 md:h-13 lg:h-15 flex items-center justify-center my-0.5 sm:my-1 relative overflow-hidden rounded-md sm:rounded-lg border border-black/10 shadow-[0_2px_8px_rgba(0,0,0,0.1)] bg-white">
                <img
              ...
              <div className="w-full pt-0.5 sm:pt-1.5">
                <div className="w-full py-0.5 sm:py-1 md:py-1.5 px-1 sm:px-2 rounded sm:rounded-md border border-[#1A1A1A]/30 group-hover:border-[#1A1A1A] group-hover:bg-[#1A1A1A] text-[#1A1A1A] group-hover:text-white font-bold text-[7.5px] sm:text-[9px] md:text-[10.5px] tracking-wider uppercase flex items-center justify-center gap-0.5 sm:gap-1 transition-all duration-300 shadow-xs">
                  <span>EXPLORE</span>
