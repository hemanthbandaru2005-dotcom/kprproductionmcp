  ...
  return (
    <div id="colorlab" className="w-full bg-[#F7F3EE] transition-all duration-300">
      <div className="w-full bg-white border-b border-[#E2D9CC] overflow-hidden transition-all duration-500">
        ...
        {/* 1. Main Collapsible "COLOR LAB" Header Bar with Clean 3-Box Layout (Left Photo | Center Logo | Right Photo) */}
        <button
        ...
        >
          ...
          <div className="w-14 h-14 sm:w-28 sm:h-28 md:w-48 md:h-34 lg:w-60 lg:h-38 shrink-0 rounded-lg sm:rounded-2xl overflow-hidden border border-[#E2D9CC] shadow-sm pointer-events-none">
            <img
              ...
              className="w-full h-full object-cover object-left group-hover:scale-105 transition-transform duration-500 select-none"
            />
          </div>
