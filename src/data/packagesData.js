export const SERVICES_PACKAGES = [
  ...
  { id: 8, name: 'Live Streaming Link', price: 6000, duration: '4 hours', category: 'Broadcast', image: '/images/packages/in_live_link.png', popular: false },
  { id: 9, name: 'Cinematic Teaser Trailer', price: 8000, duration: '4-5 min Highlight Reel', category: 'Editing', image: '/images/packages/in_teaser.png', popular: true },
  { id: 10, name: 'Traditional Video Editing', price: 2000, duration: '1 hour output', category: 'Editing', image: '/images/packages/trad_editing_user.png', popular: false },
  { id: 11, name: 'Cinematic Video Editing', price: 6000, duration: '1 hour output', category: 'Editing', image: '/images/packages/cinematic_editing_user.png', popular: false },
  { id: 12, name: 'Custom Album Sheet Print', price: 250, duration: 'per sheet (with specified images)', category: 'Print Album', image: '/images/packages/in_album_sheet.png', unit: 'sheet', popular: false }
];
