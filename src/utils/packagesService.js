...
const PACKAGES_STORAGE_KEY = 'kpr_site_packages_v12';
...
export const OFFICIAL_PHOTOGRAPHY_PACKAGES = [
  {
    ...
    popular: true,
    description: 'Comprehensive executive coverage for corporate annual general meetings, business conferences, leadership summits, and company celebrations with high-res photography and rapid media delivery.',
    features: [
  ...
  },
  {
    ...
    popular: true,
    description: 'Enterprise-grade multi-camera photography and cinematic industrial summit documentation tailored for major conglomerates, infrastructure launches, and corporate executive gatherings.',
    features: [
  ...
  },
  {
    ...
    popular: false,
    description: 'Official state protocol documentation, public summits, dignitary visits, ministry inaugurations, and foundation ceremonies with press-ready deliverables.',
    features: [
  ...
  },
  {
    ...
    popular: true,
    description: 'Dynamic commercial coverage for shopping mall grand openings, festive celebrity events, weekend promotions, architectural retail ambience, and crowd engagements.',
    features: [
  ...
  },
  {
    ...
    popular: true,
    description: 'Signature mega-retail campaign and showroom grand launch photography for leading textile and jewelry brand stores with celebrity ribbon-cuttings and fashion showcases.',
    features: [
  ...
  },
  {
    ...
    popular: false,
    description: 'Complete traditional event coverage for Telangana wedding rituals and family group portraits.',
    features: [
  ...
  },
  {
    id: 'pkg-9',
    type: 'photography',
    name: 'Cinematic Teaser Trailer',
    price: 8000,
    duration: '4-5 min Highlight Reel',
    category: 'Editing',
  ...
  },
  {
    id: 'pkg-12',
    type: 'photography',
    name: 'Custom Album Sheet Print',
    price: 250,
    duration: 'per sheet (with specified images)',
